...
String sql = " SELECT * FROM Transreturn WHERE Username = ? order by todate "; 			
...
if(row>0)
{
	String sql1 = " SELECT * FROM Transreturn WHERE Username = ? order by todate"; 			
